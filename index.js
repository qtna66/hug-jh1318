...
const UUID = process.env.UUID || 'faadca24-cf34-4fc8-b182-72deff6ae1e1'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'subjh1318';            // 获取节点的订阅路径
const NAME = process.env.NAME || 'hugjh1318';                       // 节点名称
